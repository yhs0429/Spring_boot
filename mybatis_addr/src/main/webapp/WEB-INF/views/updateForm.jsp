...
<form class="form-horizontal" 
 ...
 <input type="hidden" name="addressnum" value="${dto.addressnum}">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" name="handphone" id="handphone" class="form-control" value="${dto.handphone}">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
    <input type="text" id="zipcode" name="zipcode" class="form-control" value="${dto.zipcode}">
    </div>
  </div>
  ...
  <div class="from-group">
   ...
   <div class="col-sm-6">
	<input type="text" id="address2" name="address2" class="form-control" value="${dto.address2}">
   </div>
  </div>
